...
public class MyMethod//indicates class
{
    ...
    public double myPow(double x, int y)//method which accepts a double and integer and find the value
    {
    ...
    public double myFactorial(int n)//method which finds factorials
    {
    ...
    public double mySin(double x)//method which calculates value of sin function
    {
    ...
    public double myCos(double x)//method used to simulate cosine function
    {
    ...
    public double myDegreeToRadian(double degree)//method which converts degrees to radians
    {
    ...
    public char myToLowerCase(char c)//method which converts an upper case character to lower case
    {
